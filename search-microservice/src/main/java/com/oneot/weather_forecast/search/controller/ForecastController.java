...
import com.oneot.weather_forecast.search.dto.response.ApiResponseWrapper;
...
@Tag(name = "SearchForecast Controller", description = "SearchForecast Controller API") // Swagger tag for API documentation
public class ForecastController {
    ...
    public ResponseEntity<ApiResponseWrapper<List<ForecastResponse>>> getAllForecastsByPlace(
        ...
        List<SearchForecast> searchForecasts = forecastService.getAllForecastsByPlace(place);

        // Map the List<SearchForecast> to List<ForecastResponse>
        List<ForecastResponse> forecastResponses = forecastResponseMapper.toForecastResponseList(searchForecasts);
    ...
    public ResponseEntity<ApiResponseWrapper<ForecastResponse>> getTodayForecast() {
        Optional<SearchForecast> forecastOptional = forecastService.getTodayForecast(); // Fetch today's forecast using the service
