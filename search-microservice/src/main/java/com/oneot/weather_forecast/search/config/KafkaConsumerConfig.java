...
public class KafkaConsumerConfig {
    ...
    public Map<String, Object> consumerConfig() {
        ...
        // Add SSL properties if running with the 'prod' profile
    ...
    /**
     * Adds the SSL configuration properties to the provided map.
     * This method is called only when the 'prod' profile is active.
     *
     * @param configProps The map that holds the consumer configuration.
     */
     ...
     *
     * @return boolean True if the 'prod' profile is active, false otherwise.
     */
